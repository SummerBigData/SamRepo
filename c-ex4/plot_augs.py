...
dirs = list(filter(lambda f: f.startswith('aug_test_'), dirs))
...
plot({'data': cost_traces, 'layout': layout}, filename='aug_costs.html')
...
plot({'data': acc_traces, 'layout': layout}, filename='aug_accs.html')